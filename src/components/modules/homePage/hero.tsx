...
const Hero = () => {
  ...
  const handleSearch = () => {
    ...
    if (searchParams.location)
      params.append("searchTerm", searchParams.location);

    if (searchParams.guests) params.append("capacity", searchParams.guests);
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <p className="text-lg md:text-2xl text-white/90 mb-12 max-w-2xl mx-auto leading-relaxed font-light">
            Discover premium vessels and hidden coastal gems for your next
            maritime adventure.
          </p>
        </div>
        ...
        <div className="bg-white/95 dark:bg-card/95 backdrop-blur-md rounded-2xl md:rounded-full shadow-2xl p-2 md:p-3 max-w-5xl mx-auto animate-in fade-in zoom-in-95 duration-700 delay-300">
          <div className="grid grid-cols-1 md:grid-cols-10 gap-2 items-center">
            ...
            <div className="md:col-span-3 text-left px-4 py-2 border-b md:border-b-0 md:border-r border-border/50">
              <label className="block text-[10px] font-bold uppercase tracking-widest text-muted-foreground mb-1 ml-1">
                Location
              </label>
            ...
            <div className="md:col-span-2 p-1">
              <Button
                ...
                className="w-full h-12 md:h-14 rounded-xl md:rounded-full bg-primary text-primary-foreground hover:opacity-90 transition-all duration-300 font-bold shadow-lg shadow-primary/20 hover:cursor-pointer"
              >
